...
namespace DarkGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(TAG_Ability_Character_PropertyType_Armor, "Ability.Character.PropertyType.Armor");
	...
	FGameplayTag FindResistanceTagByEnum(const EGameplayTagResistances Resistance)
	{
		static TMap<EGameplayTagResistances, FGameplayTag> ResistanceTags{
			{EGameplayTagResistances::Armor,		TAG_Ability_Character_PropertyType_Resistance_Armor},
			{EGameplayTagResistances::Ice,		TAG_Ability_Character_PropertyType_Resistance_Ice},
			{EGameplayTagResistances::Fire,		TAG_Ability_Character_PropertyType_Resistance_Fire},
			{EGameplayTagResistances::Lightning, TAG_Ability_Character_PropertyType_Resistance_Lightning},
			{EGameplayTagResistances::Holy,		TAG_Ability_Character_PropertyType_Resistance_Holy},
			{EGameplayTagResistances::Poison,	TAG_Ability_Character_PropertyType_Resistance_Poison},
			{EGameplayTagResistances::Bleeding,	TAG_Ability_Character_PropertyType_Resistance_Bleeding},
		};
		return ResistanceTags[Resistance];
	}
}
