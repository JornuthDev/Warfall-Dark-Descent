	...
	UAbilitySystemComponent* Target)
{
	...
	{
		UE_LOG(LogTemp, Warning, TEXT("Effect %s, Modifier %d edit %s attribute"), *Effect->GetName(), Loop, Modifier.Attribute.IsValid() ? *Modifier.Attribute.AttributeName : TEXT("Attribute not valid!"));
		Loop++;
	}
