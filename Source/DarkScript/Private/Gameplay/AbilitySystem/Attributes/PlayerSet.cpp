...
void UPlayerSet::Init()
{
	...
	const TMap<FGameplayAttribute, TSubclassOf<UGameplayEffectCalculation>> Perks{
	...
	FDynamicEffect PerksPerLevelEffect(FDynamicEffectArray(Perks),
		false, "PerksPerLevelEffect");
	PerksPerLevelEffectHandle = GetDefaultAbilitySystem()->ApplyDynamicGameplayEffect(PerksPerLevelEffect);
}
