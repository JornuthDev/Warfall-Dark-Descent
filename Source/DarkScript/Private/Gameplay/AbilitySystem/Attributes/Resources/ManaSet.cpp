...
void UManaSet::Init()
{
	...
	FDynamicEffect ManaPerPerkEffect(FDynamicEffectArray(MaxAttributes), false, "ManaPerPerkEffect");
	GetDefaultAbilitySystem()->ManaPerPerkEffectHandle = GetDefaultAbilitySystem()->ApplyDynamicGameplayEffect(ManaPerPerkEffect);
}
