...
UGE_PerkToRegenRates::UGE_PerkToRegenRates()
{
	...
	// Modifier 1: HealthRegenRate
	{
		...
		HealthRegenRateModifier.Attribute = UArchetypeAttributeSet::GetHealthRegenRateAttribute();
	...
	// Modifier 2: ManaRegenRate
	{
		...
		ManaRegenRateModifier.Attribute = UArchetypeAttributeSet::GetManaRegenRateAttribute();
	...
	// Modifier 3: StaminaRegenRate
	{
		...
		StaminaRegenRateModifier.Attribute = UArchetypeAttributeSet::GetStaminaRegenRateAttribute();
	...
	// Modifier 4: FocusRegenRate
	{
		...
		FocusRegenRateModifier.Attribute = UArchetypeAttributeSet::GetFocusRegenRateAttribute();
