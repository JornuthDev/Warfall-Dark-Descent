...
UUpdateSessionAsyncAction* UUpdateSessionAsyncAction::Create(UObject* WorldContextObject, const int32 PublicConnections,
	const int32 PrivateConnections, const bool bUseLAN, const bool bAllowInvites, const bool bAllowJoinInProgress, const bool bRefreshOnlineData,
	const bool bIsDedicatedServer, const bool bShouldAdvertise, const bool bAllowJoinViaPresence, const bool bAllowJoinViaPresenceFriendsOnly)
{
...
void UUpdateSessionAsyncAction::Activate()
{
	...
	Net->UpdateSession(Settings, bRefreshOnlineData);
