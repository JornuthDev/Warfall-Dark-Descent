...
public:
	...
	static UOnlineSystem* GetSystem(UObject* WorldContextObject);
	...
	void ToFilteredResults(TArray<FSessionSearchResult>& SearchResults, const FSessionFilters& Filters) const;
	bool IsValidBeforeJoin(const FSessionSearchResult& Result, const TArray<FSessionSearchResult>& Results, ESessionJoinError& Error) const;
